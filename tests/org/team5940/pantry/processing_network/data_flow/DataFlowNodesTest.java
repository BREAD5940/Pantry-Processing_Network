...
public class DataFlowNodesTest {
	// TODO write tests. 
	
	// ConstantValueNode tests
	@Test
	...
	public void testMultiplexerValueNode_General() throws InterruptedException {
		...
		MultiplexerValueNode<Integer, TestEnum> multi = new MultiplexerValueNode<Integer, TestEnum>(network, stateValueNode, map);
